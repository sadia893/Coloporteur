...
if(isset($_POST["add"])){
	if(isset($_SESSION["cart"])){
		...
		if(!in_array($_GET["id"],$item_array_id)){
			...
			echo'<script>window.location="allstudy.php"</script>';
	   }else{
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="allstudy.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="allstudy.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
