  ...
  <body>
    <div class="abc"></div>
	  ...
	  <div class = "row">
	   ...
	   <h2>Some Books</h2>
        <?php
            $query = "SELECT * FROM booked ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="allbook.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="allbook.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
